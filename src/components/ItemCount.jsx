      ...
      <div className="count">
        <div className="buttonContainer">
          ...
          <button
            className="buttonItem "
            onClick={() => contador(+1)}
            disabled={count == objProducto.stock ? true : null}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
      ...
      <div>
        {InputType === "button" ? (
          <div className="btn-agregar">
            <button
              className="mx-auto btn btn-outline-dark btn-compra"
              onClick={() => {
                onAdd();
                inter();
              }}
          ...
          <Link to={"/cart"}>
            <div className="btn-finalizar">
              <button
                className="btn btn-outline-success btn-compra btn-fin"
                onClick={contador}
              >
                {" "}
                Finalizar compra{" "}
