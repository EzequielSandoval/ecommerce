        ...
        <div className="imgContainer">
          <div className="listImg">
            <img
              ...
              onClick={() => setChange(detailProduct.img1)}
              src={detailProduct.img1}
              alt=""
            />
            <img
              className="imgDetail2"
              onClick={() => setChange(detailProduct.img2)}
              src={detailProduct.img2}
              alt=""
            />
            <img
              className="imgDetail3"
              onClick={() => setChange(detailProduct.img3)}
              src={detailProduct.img3}
              alt=""
            />
            <img
              className="imgDetail4"
              onClick={() => setChange(detailProduct.img4)}
              src={detailProduct.img4}
              alt=""
            />
            <img
              className="imgDetail5"
              onClick={() => setChange(detailProduct.img5)}
              src={detailProduct.img5}
              alt=""
            />
          </div>
