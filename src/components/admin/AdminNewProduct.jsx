...
export const AdminNewProduct = () => {
  const changeImagen = (e) => {
    // Esta funcion recibe el evento que se activa cuando se sube un archivo
    ...
    const storageRef = ref(
      storage,
      `img/productos/${InfoValues.categoria}/${InfoValues.nombre}/${file.name}`
    ); // se crea la REFERENCIA para el archivo que subamos
  ...
  const imgUnset =
    "https://firebasestorage.googleapis.com/v0/b/sportnike-eb926.appspot.com/o/image%2FunsetImage.png?alt=media&token=2b21f922-39b8-4360-991a-11eca92a3323";
            ...
            <div className="listImg">
              ...
              <div className="labelInput">
                ...
                {Image.image1 != imgUnset ? (
                  <div className="btn-deleteContainer">
                    <button
                      className="btn  btn-sm btn-deleteImg"
                      onClick={() => deleteImg(Image.image1)}
                    >
                      <svg
              ...
              <div className="labelInput">
                ...
                {Image.image2 != imgUnset ? (
                  <div className="btn-deleteContainer">
                    <button
                      className="btn btn-danger btn-sm btn-deleteImg "
                      onClick={() => deleteImg(Image.image2)}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
              ...
              <div className="labelInput">
                ...
                {Image.image3 != imgUnset ? (
                  <div className="btn-deleteContainer">
                    <button
                      className="btn btn-danger btn-sm btn-deleteImg"
                      onClick={() => deleteImg(Image.image3)}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
              ...
              <div className="labelInput">
                ...
                {Image.image4 != imgUnset ? (
                  <div className="btn-deleteContainer">
                    <button
                      className="btn btn-danger btn-sm btn-deleteImg "
                      onClick={() => deleteImg(Image.image4)}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
              ...
              <div className="labelInput">
                ...
                {Image.image5 != imgUnset ? (
                  <div className="btn-deleteContainer">
                    <button
                      className="btn btn-danger btn-sm btn-deleteImg "
                      onClick={() => deleteImg(Image.image5)}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
          ...
          <div className="containerDescription">
            ...
            <div className="detalles">
              ...
              <div className="cuotas">
                ...
                3 , 6 y 12 <span>Sin interes</span>
              </div>
              <div className="mt-5 m-auto">
                <button
                  className="btn btn-success "
                  onClick={cargarNuevoItem}
                  disabled={IsDisabled()}
                >
