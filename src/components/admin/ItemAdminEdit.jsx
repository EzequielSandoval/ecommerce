        ...
        <div className="detailItemContainer admin">
                ...
                {UpdateImg.updateImg1 != imgUnset ? (
                  <div className="btn-deleteContainer">
                    <button
                      ...
                      onClick={() => editFunction(UpdateImg.updateImg1)}
                    >
                      <svg
              ...
              <div className="labelInput">
                ...
                {UpdateImg.updateImg1 != imgUnset ? (
                  <div className="btn-deleteContainer">
                    <button
                      className="btn  btn-sm btn-deleteImg"
                      onClick={() => editFunction(UpdateImg.updateImg2)}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
              ...
              <div className="labelInput">
                ...
                {UpdateImg.updateImg1 != imgUnset ? (
                  <div className="btn-deleteContainer">
                    <button
                      className="btn  btn-sm btn-deleteImg"
                      onClick={() => editFunction(UpdateImg.updateImg3)}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
              ...
              <div className="labelInput">
                ...
                {UpdateImg.updateImg1 != imgUnset ? (
                  <div className="btn-deleteContainer">
                    <button
                      className="btn  btn-sm btn-deleteImg"
                      onClick={() => editFunction(UpdateImg.updateImg4)}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
              ...
              <div className="labelInput">
                ...
                {UpdateImg.updateImg1 != imgUnset ? (
                  <div className="btn-deleteContainer">
                    <button
                      className="btn  btn-sm btn-deleteImg"
                      onClick={() => editFunction(UpdateImg.updateImg5)}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
          ...
          <div className="containerDescription">
            ...
            <span className="infoId">
              Codigo: nike hombre N° id: {detailProduct.id}
            </span>
            <p>
              $
              <input
